...
<Image src={image} alt="Gabor" class="float-end mt-0 w-40 px-4 sm:w-48 sm:px-4" />
...
Other technologies I like include Tailwind, Laravel and lately the web platform itself.
